...
if (!isset($_GET['id'])) {
    $_SESSION['error_message'] = 'Menu item ID is required.';
    header('Location: menu.php');
    exit();
}

$menuController = new MenuController();
$item = $menuController->getItemById($_GET['id']);
$categories = $menuController->getAllCategories();

// If item not found, redirect back to menu page
if (!$item) {
...
<head>
    ...
    <title>Edit Menu Item - Admin Dashboard</title>
...
<body>
    ...
    <main class="admin-container">
        <div class="admin-header">
            ...
            <p>Update the menu item details using the form below</p>
        </div>
        ...
        <div class="form-container">
            <form action="process_menu.php" method="POST" enctype="multipart/form-data">
                    ...
                    <select id="category" name="category" class="form-control" required>
                        ...
                        <?php foreach ($categories as $category): ?>
                            <option value="<?php echo htmlspecialchars($category['category_id']); ?>"
                                    <?php echo $category['category_id'] == $item['category'] ? 'selected' : ''; ?>>
                ...
                <div class="btn-container">
                    <button type="submit" class="btn-submit">Update Menu Item</button>
